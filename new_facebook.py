...
# -*- coding: utf-8 -*-
"""
Created on Wed Mar 27 08:39:19 2024
...
output_directory = 'Downloads/filtered_addi_eng_new_csv/'
 '''
input_directory = "Downloads/fb_english_posts/facebook_posts/"
output_directory = 'Downloads/filtered_facebook_posts_new/'
...
additional_standalone_keywords = [
    ...
    "remove user", "remove post", "remove tweet", "remove account",
    ...
    "post delete", "tweet delete", "account delete", "suspend user",
    ...
    "twitter dox","harassment", "harassment", "harassment", "harassment", "harass user",
    "user harass", "account harass", "harass account",
    "harassment",
